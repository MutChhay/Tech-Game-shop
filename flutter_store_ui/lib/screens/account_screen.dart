...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: loadMe),
        ],
      ),
  ...
  // ✅ FIXED: Compact Dark Mode Tile (70px constraint)
  Widget _darkModeTile() {
    return Padding(
      padding: const EdgeInsets.only(bottom: 12),
      child: Row(
        children: [
          // ✅ FIXED: Smaller icon container (28x28px total)
          Container(
            padding: const EdgeInsets.all(6), // Reduced from 8px
          ...
          // ✅ Compact Switch (no padding issues)
          Transform.scale(
            scale: 0.9,
            child: Switch(
